...
- **読み書きの説明**：
  ...
  - **補足説明**: `/ninja/kamui.sh` は元のファイルに対して直接「上書き」でデータを変更することをサポートしており、ファイルを直接編集する必要があるシナリオに適しています [^4]
...
[^4]: [nohajc/anylinuxfs](https://github.com/nohajc/anylinuxfs) により提供され、二次カプセル化されています
