...
* [APPERK](https://fastly.jsdelivr.net/gh/hoochanlon/free-mac-ntfs/shashin/friend's_wx.jpg)，投入了大量时间与精力梳理小工具的代码逻辑，[并对英特尔芯片兼容的特别工作，与图文并茂分解式说明](https://mp.weixin.qq.com/s/kHOsdXLXlFBardoSAsaXiA)。
