...
- <img src="../imgs/svg/system/protect.svg" alt="Status Protection" style="height: 14px; width: 14px; vertical-align: middle; margin-right: 4px; display: inline-block;"> **Status Protection Icon** - Long press for 3 seconds to toggle protection status. When protected, auto read-write, tray mode, and prevent sleep features will be disabled to prevent accidental operations. The icon appears green with a pulse animation when protected.
